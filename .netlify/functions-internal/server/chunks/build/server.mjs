import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, inject, toValue, mergeProps, unref, createVNode, resolveDynamicComponent, ref, watch, withCtx, renderSlot, openBlock, createBlock, toDisplayString, useSlots, createCommentVNode, toRef, useTemplateRef, Fragment, renderList, createTextVNode, defineComponent, shallowRef, h, resolveComponent, provide, useModel, mergeModels, hasInjectionContext, getCurrentInstance, onServerPrefetch, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, Suspense, createApp, useId, shallowReactive, useAttrs, isRef, onErrorCaptured, reactive, effectScope, nextTick, withModifiers, toHandlers, getCurrentScope, markRaw, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, k as klona, l as defu, m as parseQuery, n as defuFn, o as hasProtocol, j as joinURL, q as parseURL, r as encodePath, t as decodePath, v as isEqual, w as withQuery, x as isScriptProtocol, y as getContext, z as withTrailingSlash, A as withoutTrailingSlash, B as sanitizeStatusCode, $ as $fetch$1, C as baseURL, e as createError$1, D as executeAsync } from '../nitro/nitro.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttrs, ssrRenderSuspense, ssrRenderStyle } from 'vue/server-renderer';
import { useForwardProps, Primitive, Slot, useForwardPropsEmits, SelectRoot, SelectTrigger, SelectPortal, SelectContent, SelectGroup, SelectLabel, SelectSeparator, SelectItem, SelectItemText, SelectItemIndicator, SelectArrow, createContext, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, SwitchRoot, SwitchThumb, Label, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, RadioGroupRoot, RadioGroupItem, RadioGroupIndicator, ProgressRoot, ProgressIndicator } from 'reka-ui';
import { reactivePick, useVModel, reactiveOmit, useDebounceFn, createReusableTemplate, createSharedComposable } from '@vueuse/core';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DspaQ_G_.mjs')
  }
];
...
const _sfc_main$g = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$b), ...appConfig2.ui?.progress || {} })({
...
const _sfc_main$f = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$a), ...appConfig2.ui?.toast || {} })({
      color: props.color,
      orientation: props.orientation,
...
const _sfc_main$e = /* @__PURE__ */ Object.assign(__default__$1, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$9), ...appConfig2.ui?.toaster || {} })({
      position: props.position,
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$8), ...appConfig2.ui?.fieldGroup || {} }));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
        "data-orientation": __props.orientation,
        class: ui.value({ orientation: __props.orientation, class: [unref(uiProp)?.base, props.class] })
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig2.ui?.slideover || {} })({
...
const _sfc_main$7 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig2.ui?.switch || {} })({
      size: size.value,
      color: color.value,
...
const _sfc_main$6 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$3), ...appConfig2.ui?.select || {} })({
      color: color.value,
      variant: props.variant,
...
const _sfc_main$5 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const id = _id.value ?? useId();
    const ui = computed(() => tv({ extend: tv(theme$2), ...appConfig2.ui?.radioGroup || {} })({
      size: size.value,
      color: color.value,
      disabled: disabled.value,
      required: props.required,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.legend || !!slots.legend) {
              _push2(`<legend data-slot="legend" class="${ssrRenderClass(ui.value.legend({ class: unref(uiProp)?.legend }))}"${_scopeId}>`);
            ...
            ssrRenderList(normalizedItems.value, (item) => {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(!__props.variant || __props.variant === "list" ? "div" : unref(Label)), {
                key: item.value,
                "data-slot": "item",
                class: ui.value.item({ class: [unref(uiProp)?.item, item.ui?.item, item.class], disabled: item.disabled || unref(disabled) })
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div data-slot="container" class="${ssrRenderClass(ui.value.container({ class: [unref(uiProp)?.container, item.ui?.container] }))}"${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(RadioGroupItem), {
                      id: item.id,
                      value: item.value,
                      disabled: item.disabled || unref(disabled),
                      "data-slot": "base",
                      class: ui.value.base({ class: [unref(uiProp)?.base, item.ui?.base], disabled: item.disabled || unref(disabled) })
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                    ...
                    if (item.label || !!slots.label || (item.description || !!slots.description)) {
                      _push3(`<div data-slot="wrapper" class="${ssrRenderClass(ui.value.wrapper({ class: [unref(uiProp)?.wrapper, item.ui?.wrapper] }))}"${_scopeId2}>`);
                      if (item.label || !!slots.label) {
                        ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(!__props.variant || __props.variant === "list" ? unref(Label) : "p"), {
                          for: item.id,
                          "data-slot": "label",
                          class: ui.value.label({ class: [unref(uiProp)?.label, item.ui?.label], disabled: item.disabled || unref(disabled) })
                        }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                      ...
                      if (item.description || !!slots.description) {
                        _push3(`<p data-slot="description" class="${ssrRenderClass(ui.value.description({ class: [unref(uiProp)?.description, item.ui?.description], disabled: item.disabled || unref(disabled) }))}"${_scopeId2}>`);
                        ssrRenderSlot(_ctx.$slots, "description", {
                          item,
                          modelValue: __props.modelValue
                        }, () => {
                    ...
                    return [
                      ...
                      item.label || !!slots.label || (item.description || !!slots.description) ? (openBlock(), createBlock("div", {
                        ...
                        item.description || !!slots.description ? (openBlock(), createBlock("p", {
                          key: 1,
                          "data-slot": "description",
                          class: ui.value.description({ class: [unref(uiProp)?.description, item.ui?.description], disabled: item.disabled || unref(disabled) })
                        }, [
                          renderSlot(_ctx.$slots, "description", {
                            item,
                            modelValue: __props.modelValue
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme), ...appConfig2.ui?.modal || {} })({
      transition: props.transition,
...
function roundUp(minutes, interval) {
  return Math.ceil(minutes / interval) * interval;
}
function formatDuration(minutes) {
  const h2 = Math.floor(minutes / 60).toString().padStart(2, "0");
  const m = (minutes % 60).toString().padStart(2, "0");
  return `${h2}:${m}`;
}
const now = ref(formatTime(/* @__PURE__ */ new Date()));
let nowInterval;
...
const finalizedEntries = computed(() => {
...
function loadEntries() {
  ...
  if (stored) {
    ...
    entries.value = parsed.map((e) => ({ ...e, id: e.id || crypto.randomUUID(), date: e.date || formatDate(/* @__PURE__ */ new Date()) }));
...
function stopWorking() {
  ...
  if (active) {
    if (!active.category && !active.content) {
      ...
      active.endTime = formatTime(/* @__PURE__ */ new Date());
    }
  }
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const { isStopped: isStopped2, entries: entries2, threshold: threshold2, currentView: currentView2, collapse: collapse2, joinCharacter: joinCharacter2, roundOrder: roundOrder2, showHotkeys: showHotkeys2, defaultPrimaryThreshold: defaultPrimaryThreshold2, continueWorking: continueWorking2, startOver: startOver2 } = useWorkEntries();
    const defaultThresholdHours = computed({
      get: () => Math.floor(defaultPrimaryThreshold2.value / 60).toString().padStart(2, "0"),
      set: (v) => {
        defaultPrimaryThreshold2.value = Number(v) * 60 + defaultPrimaryThreshold2.value % 60;
      }
    });
    const defaultThresholdMinutes = computed({
      get: () => (defaultPrimaryThreshold2.value % 60).toString().padStart(2, "0"),
      set: (v) => {
        defaultPrimaryThreshold2.value = Math.floor(defaultPrimaryThreshold2.value / 60) * 60 + Number(v);
      }
    });
    ...
    const wouldCreateNewDate = computed(() => {
      if (!isStopped2.value || entries2.value.length === 0) return false;
      const today = (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
      const lastDate = entries2.value[entries2.value.length - 1]?.date;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col min-h-screen"${_scopeId}><header class="border-b border-default"${_scopeId}><div class="flex items-center justify-between mx-auto px-4 py-2"${_scopeId}><div class="flex items-center gap-4"${_scopeId}><div class="flex items-center gap-2.5 group cursor-default"${_scopeId}><h1 class="text-lg font-bold tracking-tight"${_scopeId}> Sisyphus </h1></div></div><div class="flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UFieldGroup, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UTooltip, { text: "Calendar View" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UButton, {
                          ...
                          color: "neutral",
                          label: "Calendar",
                          variant: unref(currentView2) === "calendar" ? "subtle" : "outline",
                          onClick: ($event) => currentView2.value = "calendar"
                        }, null, _parent4, _scopeId3));
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_UTooltip, { text: "Summarize View" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UButton, {
                          ...
                          color: "neutral",
                          label: "Summary",
                          variant: unref(currentView2) === "summary" ? "subtle" : "outline",
                          onClick: ($event) => currentView2.value = "summary"
                        }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_component_UButton, {
                  ...
                  _push3(ssrRenderComponent(_component_UTooltip, { text: "Record View" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UButton, {
                          icon: "i-lucide-timer",
                          color: "neutral",
                          label: "Record",
                          variant: unref(currentView2) === "record" ? "subtle" : "outline",
                          onClick: ($event) => currentView2.value = "record"
                        }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_component_UButton, {
                  ...
                  return [
                    createVNode(_component_UTooltip, { text: "Calendar View" }, {
                      default: withCtx(() => [
                        createVNode(_component_UButton, {
                          icon: "i-lucide-calendar",
                          color: "neutral",
                    ...
                    createVNode(_component_UTooltip, { text: "Summarize View" }, {
                      default: withCtx(() => [
                        createVNode(_component_UButton, {
                          icon: "i-lucide-pie-chart",
                          color: "neutral",
                    ...
                    createVNode(_component_UTooltip, { text: "Record View" }, {
                      default: withCtx(() => [
                        createVNode(_component_UButton, {
                          icon: "i-lucide-timer",
                          color: "neutral",
            ...
            if (unref(wouldCreateNewDate)) {
              _push2(ssrRenderComponent(_component_UButton, {
                label: "Start Work",
                color: "primary",
                variant: "subtle",
                icon: "i-lucide-play",
                onClick: unref(continueWorking2)
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            _push2(ssrRenderComponent(_component_UTooltip, { text: "Settings" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UButton, {
                    ...
                    color: "neutral",
                    variant: "outline",
                    onClick: ($event) => configOpen.value = true
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_UButton, {
            ...
            _push2(`</div></div></header><main class="flex-1 max-w-5xl mx-auto w-full px-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
            _push2(`</main></div>`);
            _push2(ssrRenderComponent(_component_USlideover, {
              open: unref(configOpen),
              "onUpdate:open": ($event) => isRef(configOpen) ? configOpen.value = $event : null,
              ...
              body: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col gap-6 px-2 py-3"${_scopeId2}><div class="flex flex-col gap-5 rounded-lg border border-default bg-default/30 p-4"${_scopeId2}><h3 class="text-sm font-bold flex items-center gap-2"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "i-lucide-settings",
                    class: "size-4 text-primary"
                  }, null, _parent3, _scopeId2));
                  _push3(` General </h3><div class="flex items-start justify-between gap-4"${_scopeId2}><div class="flex flex-col gap-1"${_scopeId2}><p class="text-sm font-semibold"${_scopeId2}> Show hotkeys </p><p class="text-xs text-muted leading-relaxed"${_scopeId2}> Display available keyboard shortcuts in the Record View. </p></div>`);
                  _push3(ssrRenderComponent(_component_USwitch, {
                    modelValue: unref(showHotkeys2),
                    "onUpdate:modelValue": ($event) => isRef(showHotkeys2) ? showHotkeys2.value = $event : null
                  }, null, _parent3, _scopeId2));
                  _push3(`</div><div class="flex items-start justify-between gap-4"${_scopeId2}><div class="flex flex-col gap-1"${_scopeId2}><p class="text-sm font-semibold"${_scopeId2}> Daily hours target </p><p class="text-xs text-muted leading-relaxed"${_scopeId2}> Default threshold for highlighting when a day&#39;s total reaches this amount. </p></div><div class="flex items-center gap-1"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_USelect, {
                    modelValue: unref(defaultThresholdHours),
                    "onUpdate:modelValue": ($event) => isRef(defaultThresholdHours) ? defaultThresholdHours.value = $event : null,
                    items: unref(thresholdHourOptions),
                    class: "w-20",
                    size: "sm"
                  }, null, _parent3, _scopeId2));
                  _push3(`<span class="text-sm font-mono font-bold"${_scopeId2}>:</span>`);
                  _push3(ssrRenderComponent(_component_USelect, {
                    modelValue: unref(defaultThresholdMinutes),
                    "onUpdate:modelValue": ($event) => isRef(defaultThresholdMinutes) ? defaultThresholdMinutes.value = $event : null,
                    items: unref(thresholdMinuteOptions),
                    class: "w-20",
                    size: "sm"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div></div></div><div class="flex flex-col gap-5 rounded-lg border border-default bg-default/30 p-4"${_scopeId2}><h3 class="text-sm font-bold flex items-center gap-2"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "i-lucide-pie-chart",
                    class: "size-4 text-primary"
                  }, null, _parent3, _scopeId2));
                  _push3(` Summarize View </h3><div class="flex flex-col gap-10"${_scopeId2}><section class="flex flex-col gap-4"${_scopeId2}><div class="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-muted"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "i-lucide-clock",
                    class: "size-4 text-primary"
                  }, null, _parent3, _scopeId2));
                  _push3(` Rounding </div><div class="flex flex-col gap-6 pl-5 border-l border-default/50"${_scopeId2}><div class="flex flex-col gap-2"${_scopeId2}><label class="text-sm font-semibold"${_scopeId2}>Round up to nearest</label>`);
                  _push3(ssrRenderComponent(_component_USelect, {
                    modelValue: unref(threshold2),
                    "onUpdate:modelValue": ($event) => isRef(threshold2) ? threshold2.value = $event : null,
                    items: roundUpOptions,
                    class: "w-full max-w-[200px]"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                  if (unref(threshold2) !== "none" && unref(collapse2)) {
                    _push3(`<div class="flex flex-col gap-3"${_scopeId2}><label class="text-sm font-semibold"${_scopeId2}>When to round</label>`);
                    _push3(ssrRenderComponent(_component_URadioGroup, {
                      modelValue: unref(roundOrder2),
                      "onUpdate:modelValue": ($event) => isRef(roundOrder2) ? roundOrder2.value = $event : null,
                  ...
                  _push3(`</div></section><section class="flex flex-col gap-4"${_scopeId2}><div class="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-muted"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "i-lucide-layers",
                    class: "size-4 text-primary"
                  }, null, _parent3, _scopeId2));
                  _push3(` Grouping </div><div class="flex flex-col gap-6 pl-5 border-l border-default/50"${_scopeId2}><div class="flex items-start justify-between gap-4"${_scopeId2}><div class="flex flex-col gap-1"${_scopeId2}><p class="text-sm font-semibold"${_scopeId2}> Collapse by category </p><p class="text-xs text-muted leading-relaxed"${_scopeId2}> Merge multiple entries with the same category into one. </p></div>`);
                  _push3(ssrRenderComponent(_component_USwitch, {
                    modelValue: unref(collapse2),
                    "onUpdate:modelValue": ($event) => isRef(collapse2) ? collapse2.value = $event : null
                  }, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                  if (unref(collapse2)) {
                    _push3(`<div class="flex flex-col gap-2"${_scopeId2}><label class="text-sm font-semibold"${_scopeId2}>Content join character</label><p class="text-xs text-muted leading-relaxed"${_scopeId2}> Character used to separate notes when entries are collapsed. </p>`);
                    _push3(ssrRenderComponent(_component_UInput, {
                      modelValue: unref(joinCharacter2),
                      "onUpdate:modelValue": ($event) => isRef(joinCharacter2) ? joinCharacter2.value = $event : null,
                      class: "max-w-[80px]"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div>`);
                  } else {
                  ...
                  _push3(`</div></section></div></div><div class="flex flex-col gap-5 rounded-lg border border-error/30 bg-error/5 p-4"${_scopeId2}><h3 class="text-sm font-bold flex items-center gap-2 text-error"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "i-lucide-triangle-alert",
                    class: "size-4"
                  }, null, _parent3, _scopeId2));
                  _push3(` Danger Zone </h3>`);
                  _push3(ssrRenderComponent(_component_UButton, {
                    label: "Delete all data",
                    color: "error",
                    variant: "subtle",
                    icon: "i-lucide-trash",
                    onClick: ($event) => confirmOpen.value = true
                  }, null, _parent3, _scopeId2));
                  _push3(`</div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex flex-col gap-6 px-2 py-3" }, [
                      createVNode("div", { class: "flex flex-col gap-5 rounded-lg border border-default bg-default/30 p-4" }, [
                        createVNode("h3", { class: "text-sm font-bold flex items-center gap-2" }, [
                        ...
                        createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                          createVNode("div", { class: "flex flex-col gap-1" }, [
                            createVNode("p", { class: "text-sm font-semibold" }, " Show hotkeys "),
                            createVNode("p", { class: "text-xs text-muted leading-relaxed" }, " Display available keyboard shortcuts in the Record View. ")
                          ]),
                        ...
                        createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                          createVNode("div", { class: "flex flex-col gap-1" }, [
                            createVNode("p", { class: "text-sm font-semibold" }, " Daily hours target "),
                            createVNode("p", { class: "text-xs text-muted leading-relaxed" }, " Default threshold for highlighting when a day's total reaches this amount. ")
                          ]),
                      ...
                      createVNode("div", { class: "flex flex-col gap-5 rounded-lg border border-default bg-default/30 p-4" }, [
                        createVNode("h3", { class: "text-sm font-bold flex items-center gap-2" }, [
                          ...
                          createTextVNode(" Summarize View ")
                        ]),
                        createVNode("div", { class: "flex flex-col gap-10" }, [
                          createVNode("section", { class: "flex flex-col gap-4" }, [
                            createVNode("div", { class: "flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-muted" }, [
                              createVNode(_component_UIcon, {
                                name: "i-lucide-clock",
                                class: "size-4 text-primary"
                              }),
                              createTextVNode(" Rounding ")
                            ]),
                            createVNode("div", { class: "flex flex-col gap-6 pl-5 border-l border-default/50" }, [
                              createVNode("div", { class: "flex flex-col gap-2" }, [
                                createVNode("label", { class: "text-sm font-semibold" }, "Round up to nearest"),
                                createVNode(_component_USelect, {
                                  modelValue: unref(threshold2),
                                  "onUpdate:modelValue": ($event) => isRef(threshold2) ? threshold2.value = $event : null,
                                  items: roundUpOptions,
                              ...
                              unref(threshold2) !== "none" && unref(collapse2) ? (openBlock(), createBlock("div", {
                                key: 0,
                                class: "flex flex-col gap-3"
                              }, [
                                createVNode("label", { class: "text-sm font-semibold" }, "When to round"),
                          ...
                          createVNode("section", { class: "flex flex-col gap-4" }, [
                            createVNode("div", { class: "flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-muted" }, [
                              ...
                              createTextVNode(" Grouping ")
                            ]),
                            createVNode("div", { class: "flex flex-col gap-6 pl-5 border-l border-default/50" }, [
                              createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                                createVNode("div", { class: "flex flex-col gap-1" }, [
                                  createVNode("p", { class: "text-sm font-semibold" }, " Collapse by category "),
                                  createVNode("p", { class: "text-xs text-muted leading-relaxed" }, " Merge multiple entries with the same category into one. ")
                                ]),
                                createVNode(_component_USwitch, {
                                  modelValue: unref(collapse2),
                                  "onUpdate:modelValue": ($event) => isRef(collapse2) ? collapse2.value = $event : null
                              ...
                              unref(collapse2) ? (openBlock(), createBlock("div", {
                                key: 0,
                                class: "flex flex-col gap-2"
                              }, [
                                createVNode("label", { class: "text-sm font-semibold" }, "Content join character"),
                                createVNode("p", { class: "text-xs text-muted leading-relaxed" }, " Character used to separate notes when entries are collapsed. "),
                      ...
                      createVNode("div", { class: "flex flex-col gap-5 rounded-lg border border-error/30 bg-error/5 p-4" }, [
                        createVNode("h3", { class: "text-sm font-bold flex items-center gap-2 text-error" }, [
                          createVNode(_component_UIcon, {
                            name: "i-lucide-triangle-alert",
                            class: "size-4"
                          }),
            ...
            _push2(ssrRenderComponent(_component_UModal, {
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="p-6 flex flex-col gap-4"${_scopeId2}><div class="flex items-center gap-2"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "i-lucide-triangle-alert",
                    class: "size-5 text-error"
                  }, null, _parent3, _scopeId2));
                  _push3(`<h3 class="text-lg font-bold"${_scopeId2}> Delete all data? </h3></div><p class="text-sm text-muted"${_scopeId2}> This will permanently remove all your recorded entries. This action cannot be undone. </p><div class="flex justify-end gap-2 mt-2"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UButton, {
                    label: "Cancel",
                    color: "neutral",
                    variant: "outline",
                    onClick: ($event) => confirmOpen.value = false
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_component_UButton, {
                    label: "Delete All",
                    color: "error",
                  ...
                  return [
                    createVNode("div", { class: "p-6 flex flex-col gap-4" }, [
                      createVNode("div", { class: "flex items-center gap-2" }, [
                        createVNode(_component_UIcon, {
                          name: "i-lucide-triangle-alert",
                          class: "size-5 text-error"
                        }),
                        createVNode("h3", { class: "text-lg font-bold" }, " Delete all data? ")
                      ]),
                      createVNode("p", { class: "text-sm text-muted" }, " This will permanently remove all your recorded entries. This action cannot be undone. "),
            ...
            return [
              createVNode("div", { class: "flex flex-col min-h-screen" }, [
                createVNode("header", { class: "border-b border-default" }, [
                  createVNode("div", { class: "flex items-center justify-between mx-auto px-4 py-2" }, [
                    createVNode("div", { class: "flex items-center gap-4" }, [
                      createVNode("div", { class: "flex items-center gap-2.5 group cursor-default" }, [
                        createVNode("h1", { class: "text-lg font-bold tracking-tight" }, " Sisyphus ")
                      ])
                    ]),
                    createVNode("div", { class: "flex items-center gap-2" }, [
                    ...
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      unref(wouldCreateNewDate) ? (openBlock(), createBlock(_component_UButton, {
                        key: 0,
                        label: "Start Work",
                        color: "primary",
                        variant: "subtle",
                      ...
                      createVNode(_component_UTooltip, { text: "Settings" }, {
                        default: withCtx(() => [
                          createVNode(_component_UButton, {
                            icon: "i-lucide-settings",
                            color: "neutral",
                ...
                createVNode("main", { class: "flex-1 max-w-5xl mx-auto w-full px-4" }, [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-63WARYUm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BdS8cY6F.mjs'));
...
export { __nuxt_component_0$1 as _, useAppConfig as a, useComponentUI as b, usePortal as c, useFieldGroup as d, entry_default as default, useComponentIcons as e, _sfc_main$m as f, _sfc_main$k as g, _sfc_main$h as h, _sfc_main$6 as i, _sfc_main$4 as j, useWorkEntries as k, pointerDownOutside as p, tv as t, useHead as u };
